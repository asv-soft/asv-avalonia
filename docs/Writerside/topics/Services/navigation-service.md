...
It implements the [`INavigationService`](#inavigationservice-source) and is designed to work closely with the [`IRoutable`](routable-view-model.md) View Models.
...
### INavigationService  ([source](https://github.com/asv-soft/asv-avalonia/blob/main/src/Asv.Avalonia/Services/Navigation/INavigationService.cs))
