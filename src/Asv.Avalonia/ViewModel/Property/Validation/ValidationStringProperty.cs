...
public class ValidationStringProperty
    : ValidationPropertyBase<string?, string?>,
        IValidationProperty<string?>
{
    private readonly IList<Func<string?, ValidationResult>> _validationRules = [];
    private bool _externalChange;
    private bool _internalChange;

    public ValidationStringProperty(
        string id,
    ...
    public sealed override ReactiveProperty<string?> ModelValue { get; }
