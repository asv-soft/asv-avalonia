...
public partial class ContentDialogMini : TemplatedControl
{
    ...
    protected override void OnPropertyChanged(AvaloniaPropertyChangedEventArgs change)
    {
        ...
        if (change.Property == DialogIsImageContentTypeProperty)
        {
            UpdateContentType();
        }
    }
    ...
    private void UpdateContentType()
    {
        ...
        _textPlaceHolder.IsVisible = !DialogIsImageContentType;
        _imagePlaceHolder.IsVisible = DialogIsImageContentType;
    }
}
