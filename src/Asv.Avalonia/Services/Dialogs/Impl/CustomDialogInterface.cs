...
namespace Asv.Avalonia
{
    ...
    {
            public static async Task<object?> ShowCustomDialog(Window? parent, string title, string message, bool isInputDialog = false, string defaultButton = "Close", params string[] buttonNames)
        {
        ...
        private static List<Control> CreateButtons(TaskCompletionSource<object?> tcs, Window dialog, bool isInputDialog, string defaultButton, params string[] buttonNames)
        {
            ...
            // Add keyboard navigation with highlighting
            ...
            // Set focus to default button and highlight it
            defaultBtn?.Focus();
            if (defaultBtn != null)
            {
