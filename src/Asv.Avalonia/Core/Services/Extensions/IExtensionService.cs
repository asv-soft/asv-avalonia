...
{
    /// <summary>
    /// Applies extensions for <typeparamref name="T"/> to the specified <paramref name="owner"/>.
    /// </summary>
    ...
    void Extend<T>(T owner, string ownerTypeId, CompositeDisposable ownerDisposable);
}
