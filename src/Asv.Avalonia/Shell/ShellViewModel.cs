...
public class ShellViewModel : ExtendableViewModel<IShell>, IShell
{
        ...
        : base(id, loggerFactory)
    {
        ...
        _layout = ioc.GetExport<ILayoutService>();
    ...
    private async ValueTask LoadLayout(CancellationToken cancellationToken)
    {
        ...
        try
        {
            _config = _layout.Get<ShellViewModelConfig>(this);
    ...
    private void SaveLayoutToFile()
    {
        ...
        try
        {
            ...
            _layout.SetInMemory(this, _config);
            _layout.FlushFromMemory(this);
        }
        catch (Exception e)
        {
