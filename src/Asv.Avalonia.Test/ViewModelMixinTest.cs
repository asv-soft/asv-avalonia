...
public class ViewModelMixinTest
{
    [Fact]
    public void TryCreateViewModel_FactoryIsRegistered_ReturnsViewModel()
    {
        ...
        services.AddTransient<ViewModelMixin.FactoryDelegate<ITestViewModel, string>>(_ =>
    ...
    public void TryCreateViewModel_KeyedFactoryIsRegistered_ReturnsViewModel()
    {
        // Arrange
        var services = new ServiceCollection();
        services.AddKeyedTransient<ViewModelMixin.FactoryDelegate<ITestViewModel, string>>(
            "registered",
