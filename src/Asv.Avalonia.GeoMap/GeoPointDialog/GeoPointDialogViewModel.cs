...
public class GeoPointDialogViewModel : DialogViewModelBase
{
        ...
        : base(DialogId, loggerFactory)
    {
        ...
        GeoPointProperty = new ValidationGeoPointProperty(
        ...
        GeoPointProperty
            ...
            {
                if (_anchor.ReactiveLocation.Value.Equals(location) || IsGeoPointBad(location))
                {
                    return;
                }
    ...
    public ValidationGeoPointProperty GeoPointProperty { get; }
    ...
    private bool IsGeoPointBad(GeoPoint geoPoint)
    {
