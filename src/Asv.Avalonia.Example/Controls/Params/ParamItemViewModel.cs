...
public class ParamItemViewModel : RoutableViewModel // TODO: Сделать все свойства и команды рутбл
{
    ...
    public ParamItemViewModel(NavigationId id, ParamItem paramItem, ILoggerFactory log)
        : base(id)
    {
        ...
        IsStarred = new BindableReactiveProperty<bool>();
